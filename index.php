...
<?php if (isset($_SESSION['user_id'])) { ?>
	<p>Vous, <b><?= "{$user['username']}" ?></b>... comment allez-vous en ce jour-ci? Observez avec des yeux sans nuages de haine la <a href="galerie.php">galerie</a>. L'inspiration divine pénétrera obligatoirement vos binoculaires et ainsi vous ferez le pèlerinage d'un clic vers <a href="montage.php">l'atelier</a> créer!</p>
<?php } else { ?>
